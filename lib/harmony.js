...
var Harmony = Item.extend("Harmony", ["root", "intervals", "bass", "text"], {
  inspect: function() {
  ...
  init: function() {
    ...
    //this.root = misc.initSubObject(this.root, this.env, Pitch);
...
Harmony.fromString = function(str, env) {
  ...
  if (matches) {
    ...
    return new Harmony({root: root, intervals: intervalList, bass: bass, text: rest}, env);
  }
}
